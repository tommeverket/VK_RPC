...
![VK Music RPC Demo](https://img.shields.io/badge/demo-screenshot-blue)
...
# Создание EXE
pyinstaller --onefile --windowed --noconsole --clean --name "VKMusicRPC" --add-data "config.json;." main.py
~~~
...
# Создание EXE
nuitka --onefile --standalone --disable-console --output-dir=dist main.py
~~~

### Вариант 3: Auto-py-to-exe (GUI)
~~~bash
